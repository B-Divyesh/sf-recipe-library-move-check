...
function resultLedger(): string {
  return `<section class="ledger" aria-labelledby="ledger-title">
    ...
    <div class="evidence-list">
      <article><span class="proof proof-red" aria-hidden="true">!</span><div><h3>Lemon Pasta may already exist</h3><p>The names and ingredients match. The image files match exactly.</p></div><span class="confidence">high</span></article>
